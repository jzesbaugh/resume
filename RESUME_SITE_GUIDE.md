...
4. Upload **`index.html`, `README.md`, `og.png`, `svg-flier-front.png`, `svg-flier-back.png` and
   `wotw-trailer-thumb.png`** (the last three added rev 3o/3p) to `github.com/jzesbaugh/resume`
   via **Add file → Upload files**. Same filenames replace the existing ones
5. Commit to `main`
